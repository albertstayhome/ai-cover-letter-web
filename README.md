...
## Privacy First
Your resume and job description are **never** sent to any backend server. The application runs entirely in your browser and communicates directly with the Google Gemini API using your personal API key.
